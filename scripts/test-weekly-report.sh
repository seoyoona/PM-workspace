#!/usr/bin/env bash
# /weekly-report offline regression harness (Wave 2-3)
# 외부 write 없음 — tests/weekly-report/outputs/ synthetic snapshot 검사.
# Sources scripts/lib/harness-common.sh.
# Usage: bash scripts/test-weekly-report.sh
...
echo "=========================================="
echo "/weekly-report Wave 2-3 자동 검증 하네스"
