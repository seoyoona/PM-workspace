#!/usr/bin/env bash
# /srs-translate offline regression harness (Wave 2-1)
# 외부 write 없음 — tests/srs-translate/outputs/ synthetic snapshot 검사.
# Sources scripts/lib/harness-common.sh.
# Usage: bash scripts/test-srs-translate.sh
...
echo "=========================================="
echo "/srs-translate Wave 2-1 자동 검증 하네스"
