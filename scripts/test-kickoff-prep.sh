#!/usr/bin/env bash
# /kickoff-prep offline regression harness (Wave 2-5)
# 외부 write 없음 — tests/kickoff-prep/outputs/ synthetic snapshot 검사.
# Sources scripts/lib/harness-common.sh.
# Usage: bash scripts/test-kickoff-prep.sh
...
echo "=========================================="
echo "/kickoff-prep Wave 2-5 자동 검증 하네스"
