#!/usr/bin/env bash
# /create-srs offline regression harness (Wave 2-2)
# 외부 write 없음 — tests/create-srs/outputs/ synthetic snapshot 검사.
# Sources scripts/lib/harness-common.sh.
# Usage: bash scripts/test-create-srs.sh
...
echo "=========================================="
echo "/create-srs Wave 2-2 자동 검증 하네스"
