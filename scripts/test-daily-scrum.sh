#!/usr/bin/env bash
# /daily-scrum offline regression harness (Wave 1-D)
# 외부 write 없음 — tests/daily-scrum/outputs/ synthetic snapshot 검사.
# Sources scripts/lib/harness-common.sh.
# Baseline: daily-scrum stabilization commit 21604c1 (PM Action Hub preview/gate).
# Usage: bash scripts/test-daily-scrum.sh
...
echo "/daily-scrum Wave 1-D 자동 검증 하네스"
