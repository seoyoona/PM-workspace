#!/usr/bin/env bash
# /issue-ticket offline regression harness (Wave 2-4)
# 외부 write 없음 — tests/issue-ticket/outputs/ synthetic snapshot 검사.
# Sources scripts/lib/harness-common.sh.
# Usage: bash scripts/test-issue-ticket.sh
...
echo "=========================================="
echo "/issue-ticket Wave 2-4 자동 검증 하네스"
