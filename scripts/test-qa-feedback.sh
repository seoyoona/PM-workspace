#!/usr/bin/env bash
# /qa-feedback offline regression harness (Wave 1-A)
# 외부 write 없음 — tests/qa-feedback/outputs/ 에 PM이 손으로 curate한 synthetic snapshot 만 검사.
# Sources scripts/lib/harness-common.sh (Wave 0 shared library).
# Usage: bash scripts/test-qa-feedback.sh
...
CASES=(case01 case02 case04 case05 case06 case07 case08 case03)
TESTS_DIR="tests/qa-feedback"
...
# Find output file matching case ID prefix.
# case03 (gate=3 cancel) keeps a synthetic snapshot with status: Cancelled — file IS expected.
...
echo "=========================================="
echo "/qa-feedback Wave 1-A 자동 검증 하네스"
