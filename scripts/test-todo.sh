#!/usr/bin/env bash
# /todo offline regression harness (Wave 2-7)
# 외부 write 없음 — tests/todo/outputs/ synthetic snapshot 검사.
# Sources scripts/lib/harness-common.sh.
# Usage: bash scripts/test-todo.sh
